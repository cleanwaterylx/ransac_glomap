...
def ransac_edges(graph, edges, group1, group2, i, j, max_iter=100):
    ...
    for iter in range(max_iter):
        ...
        # sample_edges = [('00039.png', '00041.png'), ('00039.png', '00042.png'), ('00039.png', '00043.png'), ('00040.png', '00041.png'), ('00040.png', '00042.png'), ('00040.png', '00043.png'),('00038.png', '00041.png'), ('00037.png', '00041.png')]
        # print(samples)
        ...
        for img1, img2 in success_edges.keys():
            ...
            print(q, q_mean)
            print(img1, img2)
            print(f"角度误差: {rotation_error:.3f}, 平移误差: {trans_error:.3f}", {0.05 * np.linalg.norm(t_mean)})
            # input()
...
if __name__ == "__main__":
    ...
    for i in range(len(groups)) :
        for j in range(i + 1, len(groups)):
            if not groups[i]['use'] or not groups[j]['use']:
                continue
            group1 = groups[i]
            group2 = groups[j]
            edges = []
    ...
    time_end = time.time()
    print(f"RANSAC 总共用时: {time_end - time_start:.2f} 秒")
